...
function Filters({ category, setCategory, size, setSize, color, setColor, maxPrice, setMaxPrice, sizes, colors }) {
  return (
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="grid gap-10 lg:grid-cols-[280px_1fr]">
          <motion.aside className="hidden border-r border-black/10 pr-6 lg:block" initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }}>
            <Filters category={category} setCategory={setCategory} size={size} setSize={setSize} color={color} setColor={setColor} maxPrice={maxPrice} setMaxPrice={setMaxPrice} sizes={allSizes} colors={allColors} />
          </motion.aside>
